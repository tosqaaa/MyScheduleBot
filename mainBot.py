...
import logging
import asyncio
from db import Subscriber, create_schedule_db, update_schedule, getDataFromDB
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    for i in range(1, 7):
        # 11_1
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️\n" + getDataFromDB(group_id="11_1", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    for i in range(1, 7):
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️\n" + getDataFromDB(group_id="18_1", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    for i in range(1, 7):
        # 17_1
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️\n" + getDataFromDB(group_id="17_1", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    for i in range(1, 7):
        # 12_1
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️\n" + getDataFromDB(group_id="12_1", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    for i in range(1, 7):
        # 15
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️\n" + getDataFromDB(group_id="15_1", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    for i in range(1, 7):
        # 14
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️\n" + getDataFromDB(group_id="14_1", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    for i in range(1, 7):
        # 16
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️\n" + getDataFromDB(group_id="16_1", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    await bot.send_message(callback_query.from_user.id, text=SELECTED_UIR)
    for i in range(1, 7):
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️\n" + getDataFromDB(group_id="13_2", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    await bot.send_message(callback_query.from_user.id, text=SELECTED_POKS)
    for i in range(1, 7):
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️\n" + getDataFromDB(group_id="11_2", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    await bot.send_message(callback_query.from_user.id, text=SELECTED_FIZ)
    for i in range(1, 7):
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️\n" + getDataFromDB(group_id="18_2", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    await bot.send_message(callback_query.from_user.id, text=SELECTED_MI)
    for i in range(1, 7):
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️\n" + getDataFromDB(group_id="17_2", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    await bot.send_message(callback_query.from_user.id, text=SELECTED_WEB)
    for i in range(1, 7):
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️\n" + getDataFromDB(group_id="12_2", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    await bot.send_message(callback_query.from_user.id, text=SELECTED_PM)
    for i in range(1, 7):
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️\n" + getDataFromDB(group_id="15_2", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    await bot.send_message(callback_query.from_user.id, text=SELECTED_POIT)
    for i in range(1, 7):
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️\n" + getDataFromDB(group_id="14_2", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
...
async def process_callback_button1(callback_query: types.CallbackQuery):
    ...
    await bot.send_message(callback_query.from_user.id, text=SELECTED_ISIT)
    for i in range(1, 7):
        await bot.send_message(callback_query.from_user.id, text=f"<b><i>{get_ws()[1]}</i></b>\n \n♦️<i><b><u>{DAYS_RU[6-i]}</u></b></i>♦️ \n" + getDataFromDB(group_id="16_2", day=DAYS[6-i]))
        await bot.send_message(callback_query.from_user.id, text="⭐️⭐️⭐️⭐️⭐️⭐️")
